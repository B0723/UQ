...
tokenizer = AutoTokenizer.from_pretrained("/data2/yxbu/.cache/huggingface/hub/models--microsoft--deberta-large-mnli/snapshots/7296194b9009373def4f7c5dad292651e4b5cf4e")
model = AutoModelForSequenceClassification.from_pretrained("/data2/yxbu/.cache/huggingface/hub/models--microsoft--deberta-large-mnli/snapshots/7296194b9009373def4f7c5dad292651e4b5cf4e").cuda()
...
with open(f'{config.output_dir}/sequences/{run_name}/{args.generation_model}_generations_similarities.pkl', 'wb') as outfile:
