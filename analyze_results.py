...
def get_likelihoods_df():
    ...
    with open(f'{config.output_dir}/sequences/{run_name}/aggregated_likelihoods_{model_name}_generations.pkl', 'rb') as f:
        ...
        keys_to_use = ('ids', 'predictive_entropy', 'mutual_information', 'average_predictive_entropy',\
                        ...
                        'new_predictive_entropy_over_concepts')
...
new_entropy_over_concepts_auroc = sklearn.metrics.roc_auc_score(1 - result_df['correct'],
                                                            result_df['new_predictive_entropy_over_concepts'])
result_dict['entropy_over_concepts_auroc'] = entropy_over_concepts_auroc
result_dict['new_entropy_over_concepts_auroc'] = new_entropy_over_concepts_auroc
...
if args.verbose:
    ...
    print(result_df['new_predictive_entropy_over_concepts'].mean())

    print('ln_predictive_entropy_auroc', ln_predictive_entropy_auroc)
    print('semantci entropy auroc', entropy_over_concepts_auroc)
    print('new semantci entropy auroc', new_entropy_over_concepts_auroc)
