...
squad_metric = evaluate.load("/data2/yxbu/semantic_uncertainty/code/squad.py")
rouge = evaluate.load('/data2/yxbu/semantic_uncertainty/code/rouge.py')
exact_match_metric = evaluate.load("/data2/yxbu/semantic_uncertainty/code/exact_match.py")
