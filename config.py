...
data_dir = '/data2/yxbu/semantic_uncertainty/code'
hf_datasets_cache = '/data2/yxbu/semantic_uncertainty/code'
output_dir = '/data2/yxbu/semantic_uncertainty/code'
hf_cache_dir = '/data2/yxbu/semantic_uncertainty/code'
